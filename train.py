...
args_parser.add_argument('-batch-size', type=int, default=64, help='batch size for training [default: 100]')
...
if __name__ == '__main__':
    ...
    data_train = ["./train_full.json", "./data/nyt/raw_nyt/train.json"]
    model_save = ['./data/TACRED/eval', './data/nyt/eval']
